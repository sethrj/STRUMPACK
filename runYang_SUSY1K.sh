...
# export DATA=/project/projectdirs/m2957/liuyangz/my_research/ML/SUSY_Origin/susy_1Kn
export DATA=/home/administrator/Desktop/research/ML/SUSY/susy_1Kn
...
--hss_leaf_size ${LEAF} --hss_rel_tol ${ACC} --hss_compression_algorithm original --hss_d0 128 --hss_max_rank 1024 2>&1 | tee -a susy_kernel1K.out
